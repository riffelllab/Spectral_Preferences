...
Upload_Folder_ID = '12NauPZsd3_o7F6lfUzh5K6xp0ble4J9f'
...
waitTime = 900		# Wait 15 min (900 s) before starting air
...
totalExpDuration = \
  ...
  3 * measureBuffer + \
  3 * odorBuffer + \
  4 * len(gray_VGR_black) * (StimTime + interStimTime) + \
  postCO2Time
...
try:
  ...
  print('\n ================== ')
  print('\nStarting CO2 only period at %s'%time_stamps[-1][1])
  print('\nCurrSett clean air controller %s'%Settings_CleanAirCtr)
  print('\nCurrSett CO2 controller %s'%Settings_CO2_Ctr)
  print('\nCurrSett odor air controller %s'%Settings_OdorAirCtr)
  ...
  for i in range(len(gray_VGR_black)):
    #Add timestamp for stimulus
    add_timestamp("start_" + "CO2_" + gray_VGR_black[i] )
    #Upload stimulus
    arduino_upload(gray_VGR_black[i])
    #Leave LED stimulus on for the StimTime
    time.sleep(StimTime-uploadTime)
    #Add timestamp for stimulus
    add_timestamp("end_" + "CO2_" + gray_VGR_black[i])
    #outputs time stamp to console
    print ("-- Stimulus period complete at %s --"%time_stamps[-1][1])
    #LEDs controller set to neutral state
    arduino_upload(arduino_neutral)
  ...
  #Stop the flow of CO2, start the flow of odor and reduce the flow of 
  #the clean air flow controller to keep total air flow constant at 190.0
  ...
  print('\n ================== ')
  print('\nStarting odor only period at %s'%time_stamps[-1][1])
  print('\nCurrSett clean air controller %s'%Settings_CleanAirCtr)
  print('\nCurrSett CO2 controller %s'%Settings_CO2_Ctr)
  print('\nCurrSett odor air controller %s'%Settings_OdorAirCtr)
  ...
  for i in range(len(gray_VGR_black)):
    #Add timestamp for stimulus
    add_timestamp("start_" + "odor_" + gray_VGR_black[i] )
    #Upload stimulus
    arduino_upload(gray_VGR_black[i])
    #Leave LED stimulus on for the StimTime
    time.sleep(StimTime-uploadTime)
    #Add timestamp for stimulus
    add_timestamp("end_" + "odor_" + gray_VGR_black[i])
    #outputs time stamp to console
    print ("-- Stimulus period complete at %s --"%time_stamps[-1][1])
    #LEDs controller set to neutral state
    arduino_upload(arduino_neutral)
...
#--------------------------------------------------------------------------------
  ...
  print('\n ================== ')
  print('\nStarting CO2 and odor period at %s'%time_stamps[-1][1])
  print('\nCurrSett clean air controller %s'%Settings_CleanAirCtr)
  print('\nCurrSett CO2 controller %s'%Settings_CO2_Ctr)
  print('\nCurrSett odor air controller %s'%Settings_OdorAirCtr)
  ...
  for i in range(len(gray_VGR_black)):
    #Add timestamp for stimulus
    add_timestamp("start_" + "CO2 and odor_" + gray_VGR_black[i] )
    #Upload stimulus
    arduino_upload(gray_VGR_black[i])
    #Leave LED stimulus on for the StimTime
    time.sleep(StimTime-uploadTime)
    #Add timestamp for stimulus
    add_timestamp("end_" + "CO2 and odor_" + gray_VGR_black[i])
    #outputs time stamp to console
    print ("-- Stimulus period complete at %s --"%time_stamps[-1][1])
    #LEDs controller set to neutral state
    arduino_upload(arduino_neutral)
  ...
  #Get current setting for output to console before contoller closes
  Settings_CleanAirCtr = CleanAirCtr.get()
  Settings_CO2_Ctr = 	 CO2_Ctr.get()
  Settings_OdorAirCtr =  OdorAirCtr.get()

  print('\n ================== ')
  print('\nStarting post-CO2 time, odor/CO2 off at %s'%time_stamps[-1][1])
  print('\nCurrSett clean air controller %s'%Settings_CleanAirCtr)
  print('\nCurrSett CO2 controller %s'%Settings_CO2_Ctr)
  print('\nCurrSett odor air controller %s'%Settings_OdorAirCtr)
