...
Upload_Folder_ID = '1pVnp7JkkxKLono4YQuVGq8wfLqyvU5Bt'
...
projectFileDir = "/home/wtunnel/Desktop/Arduino Code/color, intensity ramps/" #folder location for arduino sketches
...
ramp_430 = [
   'a_430_3.00_b_gray_0.50',
   'a_gray_0.50_b_430_3.00',
   'a_430_2.00_b_gray_0.50',
   'a_gray_0.50_b_430_2.00',
   'a_430_1.50_b_gray_0.50',
   'a_gray_0.50_b_430_1.50',
   'a_430_1.00_b_gray_0.50',
   'a_gray_0.50_b_430_1.00',
   'a_430_0.70_b_gray_0.50',
   'a_gray_0.50_b_430_0.70',
   'a_430_0.40_b_gray_0.50',
   'a_gray_0.50_b_430_0.40',
   'a_430_0.20_b_gray_0.50',
   'a_gray_0.50_b_430_0.20',   
   'a_all_0.00_b_gray_0.50',
   'a_gray_0.50_b_all_0.00']

ramp_gray = [
   'a_gray_1.50_b_gray_0.50',
   'a_gray_0.50_b_gray_1.50',
   'a_gray_1.20_b_gray_0.50',
   'a_gray_0.50_b_gray_1.20',
   'a_gray_1.00_b_gray_0.50',
   'a_gray_0.50_b_gray_1.00',
   'a_gray_0.80_b_gray_0.50',
   'a_gray_0.50_b_gray_0.80',
   'a_gray_0.60_b_gray_0.50',
   'a_gray_0.50_b_gray_0.60',
   'a_gray_0.40_b_gray_0.50',
   'a_gray_0.50_b_gray_0.40',
   'a_gray_0.20_b_gray_0.50',
   'a_gray_0.50_b_gray_0.20',   
   'a_all_0.00_b_gray_0.50',
   'a_gray_0.50_b_all_0.00']
   
ramp_545 = [
   'a_545_3.00_b_gray_0.50',
   'a_gray_0.50_b_545_3.00',
   'a_545_2.00_b_gray_0.50',
   'a_gray_0.50_b_545_2.00',
   'a_545_1.50_b_gray_0.50',
   'a_gray_0.50_b_545_1.50',
   'a_545_1.00_b_gray_0.50',
   'a_gray_0.50_b_545_1.00',
   'a_545_0.70_b_gray_0.50',
   'a_gray_0.50_b_545_0.70',
   'a_545_0.40_b_gray_0.50',
   'a_gray_0.50_b_545_0.40',
   'a_545_0.20_b_gray_0.50',
   'a_gray_0.50_b_545_0.20',   
   'a_all_0.00_b_gray_0.50',
   'a_gray_0.50_b_all_0.00']
...
totalExpDuration = \
  measureBuffer + waitTime + \
  measureBuffer + preCO2Time + \
  2 * StimTime + \
  measureBuffer + 2 * StimTime + \
  (StimTime + interStimTime + StimTime) + \
  len(ramp_545) * (StimTime + interStimTime) + \
  len(ramp_gray) * (StimTime + interStimTime) + \
  len(ramp_430) * (StimTime + interStimTime) + \
  measureBuffer + postCO2Time
...
try:
  ...
  print('\nInitial response test without odor or CO2')
  add_timestamp("start_" + "resp check, initial no odor_" + 'a_all_0.00_b_gray_1.00')
  #Upload stimulus
  arduino_upload('a_all_0.00_b_gray_1.00')
  #Leave LED stimulus on for the twice the StimTime
  #(Stimulus not switched between sides)
  time.sleep(2*StimTime-uploadTime)

  #--------------------------------------------------------------------------------
  
  #Start the flow of CO2 and odor air, 
  #reduce flow of clean air to keep air flow constant at 190
  change_setpoint(CleanAirCtr, 168.5)
  change_setpoint(CO2_Ctr, 21.5)
  change_setpoint(OdorAirCtr, 21.5)
  ...
  print('\n ================== ')
  print('\nStarting odor stimulus period, odor released at %s'%time_stamps[-1][1])
  print('\nCurrSett clean air controller %s'%Settings_CleanAirCtr)
  print('\nCurrSett CO2 controller %s'%Settings_CO2_Ctr)
  print('\nCurrSett odor air controller %s'%Settings_OdorAirCtr)

  #Add timestamp for start of CO2 and odor
  add_timestamp('start_PreStim_' + arduino_neutral)
  
  print('\nResponse test with odor and/or CO2 but without visual stimuli')
  #LEDs controller set to neutral state
  arduino_upload(arduino_neutral)

  #Wait twice the StimTime (Stimulus not switched between sides)
  time.sleep(2*StimTime-uploadTime)
  
  #--------------------------------------------------------------------------------

  print('\nInitial response test with odor or CO2')
  #Initial black vs neutral grey to test response strength
  #Add timestamp for start of stimulus
  add_timestamp("start_" + "resp check, initial odor_" + 'a_gray_1.00_b_all_0.00')
  #Upload stimulus
  arduino_upload('a_gray_1.00_b_all_0.00')
  #Leave LED stimulus on for the StimTime
  time.sleep(StimTime-uploadTime)
  #Add timestamp for end of stimulus
  add_timestamp("end_" + "resp check, initial odor_" + 'a_gray_1.00_b_all_0.00')
  #LEDs controller set to neutral state
  arduino_upload(arduino_neutral)
  #Leave LEDs in neutral state for the interStimTime
  time.sleep(interStimTime-uploadTime)
  #Add timestamp for start of stimulus
  add_timestamp("start_" + "resp check, initial odor_" + 'a_all_0.00_b_gray_1.00')
  #Upload stimulus
  arduino_upload('a_all_0.00_b_gray_1.00')
  #Leave LED stimulus on for the StimTime
  time.sleep(StimTime-uploadTime)
  #Add timestamp for end of stimulus
  add_timestamp("end_" + "resp check, initial odor_" + 'a_all_0.00_b_gray_1.00')
  ...
  #Displays a range of red stimuli
  for i in range(len(ramp_545)):
    #Add timestamp for start of stimulus
    add_timestamp("start_" + "545 nm intensity ramp_" + ramp_545[i] )
    #Upload stimulus
    arduino_upload(ramp_545[i])
    #Leave LED stimulus on for the StimTime
    time.sleep(StimTime-uploadTime)
    #Add timestamp for end of stimulus
    add_timestamp("end_" + "545 nm intensity ramp_" + ramp_545[i])
  ...
  #Displays a range of gray stimuli
  for i in range(len(ramp_gray)):
    #Add timestamp for start of stimulus
    add_timestamp("start_" + "gray intensity ramp_" + ramp_gray[i] )
    #Upload stimulus
    arduino_upload(ramp_gray[i])
    #Leave LED stimulus on for the StimTime
    time.sleep(StimTime-uploadTime)
    #Add timestamp for end of stimulus
    add_timestamp("end_" + "gray intensity ramp_" + ramp_gray[i])
    #outputs time stamp to console
    print ("-- Stimulus period complete at %s --"%time_stamps[-1][1])
    #LEDs controller set to neutral state
    arduino_upload(arduino_neutral)
  ...
  #Displays a range of blue stimuli
  for i in range(len(ramp_430)):
    #Add timestamp for start of stimulus
    add_timestamp("start_" + "430 nm intensity ramp_" + ramp_430[i] )
    #Upload stimulus
    arduino_upload(ramp_430[i])
    #Leave LED stimulus on for the StimTime
    time.sleep(StimTime-uploadTime)
    #Add timestamp for end of stimulus
    add_timestamp("end_" + "430 nm intensity ramp_" + ramp_430[i])
    #outputs time stamp to console
    print ("-- Stimulus period complete at %s --"%time_stamps[-1][1])
    #LEDs controller set to neutral state
    arduino_upload(arduino_neutral)
  ...
  #Set the mass flow controllers to deliver clean air only
  change_setpoint(CleanAirCtr, 190.0)
  ...
  print('\n ================== ')
  print('\nStarting post odor period, CO2/odor closed at %s'%time_stamps[-1][1])
  print('\nCurrSett clean air controller %s'%Settings_CleanAirCtr)
  print('\nCurrSett CO2 controller %s'%Settings_CO2_Ctr)
  print('\nCurrSett odor air controller %s'%Settings_OdorAirCtr)

  #Add timestamp for end of CO2/odor
  add_timestamp('start_PostCO2Time_' + arduino_neutral) 

  #LEDs controller set to neutral state
  print('\nSwitching Arduino LED controllers to neutral gray on both sides')
  arduino_upload(arduino_neutral)
  
  #Wait post CO2/odor period
  time.sleep(postCO2Time-uploadTime)
  ...
  #Stop the flow and close the air flow controllers
  change_setpoint(CleanAirCtr, 0.0)
  change_setpoint(CO2_Ctr, 0.0)
  change_setpoint(OdorAirCtr, 0.0)
  CleanAirCtr.close()
