...
Upload_Folder_ID = '1ukm3aL5oGbKI6ZTyYLYXXWdScn4VABfQ'
...
ramp_525 = [
   'a_525_3.00_b_gray_0.50',
   'a_gray_0.50_b_525_3.00',
   'a_525_2.00_b_gray_0.50',
   'a_gray_0.50_b_525_2.00',
   'a_525_1.50_b_gray_0.50',
   'a_gray_0.50_b_525_1.50',
   'a_525_1.00_b_gray_0.50',
   'a_gray_0.50_b_525_1.00',
   'a_525_0.70_b_gray_0.50',
   'a_gray_0.50_b_525_0.70',
   'a_525_0.40_b_gray_0.50',
   'a_gray_0.50_b_525_0.40',
   'a_525_0.20_b_gray_0.50',
   'a_gray_0.50_b_525_0.20',   
   'a_all_0.00_b_gray_0.50',
   'a_gray_0.50_b_all_0.00']
...
totalExpDuration = \
  ...
  len(ramp_525) * (StimTime + interStimTime) + \
...
try:
  ...
  #Displays a range of green stimuli
  for i in range(len(ramp_525)):
    #Add timestamp for start of stimulus
    add_timestamp("start_" + "525 nm intensity ramp_" + ramp_525[i] )
    #Upload stimulus
    arduino_upload(ramp_525[i])
    #Leave LED stimulus on for the StimTime
    time.sleep(StimTime-uploadTime)
    #Add timestamp for end of stimulus
    add_timestamp("end_" + "525 nm intensity ramp_" + ramp_525[i])
    #outputs time stamp to console
    print ("-- Stimulus period complete at %s --"%time_stamps[-1][1])
    #LEDs controller set to neutral state
    arduino_upload(arduino_neutral)
