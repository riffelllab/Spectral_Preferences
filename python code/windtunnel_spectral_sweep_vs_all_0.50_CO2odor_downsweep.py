...
Upload_Folder_ID = '1sowPtw0uwWJgcovj9frNhEBgDIledcgL'
...
#Spectral upsweep 385 nm -> 740 nm or downsweep 740 nm -> 385 nm
upsweep = [
   'a_385_1.00_b_gray_0.50',
   'a_gray_0.50_b_385_1.00',
   'a_395_1.00_b_gray_0.50',
   'a_gray_0.50_b_395_1.00',
   'a_415_1.00_b_gray_0.50',
   'a_gray_0.50_b_415_1.00',
   'a_430_1.00_b_gray_0.50',
   'a_gray_0.50_b_430_1.00',
   'a_450_1.00_b_gray_0.50',
   'a_gray_0.50_b_450_1.00',
   'a_470_1.00_b_gray_0.50',
   'a_gray_0.50_b_470_1.00',
   'a_505_1.00_b_gray_0.50',
   'a_gray_0.50_b_505_1.00',
   'a_525_1.00_b_gray_0.50',
   'a_gray_0.50_b_525_1.00',
   'a_545_1.00_b_gray_0.50',
   'a_gray_0.50_b_545_1.00',
   'a_570_1.00_b_gray_0.50',
   'a_gray_0.50_b_570_1.00',
   'a_590_1.00_b_gray_0.50',
   'a_gray_0.50_b_590_1.00',
   'a_625_1.00_b_gray_0.50',
   'a_gray_0.50_b_625_1.00',
   'a_645_1.00_b_gray_0.50',
   'a_gray_0.50_b_645_1.00',
   'a_660_1.00_b_gray_0.50',
   'a_gray_0.50_b_660_1.00',
   'a_680_1.00_b_gray_0.50',
   'a_gray_0.50_b_680_1.00',
   'a_700_1.00_b_gray_0.50',
   'a_gray_0.50_b_700_1.00',
   'a_740_1.00_b_gray_0.50',
   'a_gray_0.50_b_740_1.00']
...
totalExpDuration = \
  ...
  len(grayramp) * (StimTime + interStimTime) + \
  len(downsweep) * (StimTime + interStimTime) + \
...
try:
  ...
  for i in range(len(grayramp)):
    #Add timestamp for start of stimulus
    add_timestamp("start_" + "intensity ramp_" + grayramp[i] )
    #Upload stimulus
    arduino_upload(grayramp[i])
    #Leave LED stimulus on for the StimTime
    time.sleep(StimTime-uploadTime)
    #Add timestamp for end of stimulus
    add_timestamp("end_" + "intensity ramp_" + grayramp[i])
  ...
  #Displays a range of test stimuli from 385 nm to 740 nm
  for i in range(len(downsweep)):
    #Add timestamp for start of stimulus
    add_timestamp("start_" + "spectral downsweep_" + downsweep[i] )
    #Upload stimulus
    arduino_upload(downsweep[i])
    #Leave LED stimulus on for the StimTime
    time.sleep(StimTime-uploadTime)
    #Add timestamp for end of stimulus
    add_timestamp("end_" + "spectral downsweep_" + downsweep[i])
    #outputs time stamp to console
    print ("-- Stimulus period complete at %s --"%time_stamps[-1][1])
    #LEDs controller set to neutral state
    arduino_upload(arduino_neutral)
  ...
  print('\nEnd of the experiment response check')
  #Final black vs neutral grey to test response strength at the end of the experiment
  #Add timestamp for start of stimulus
  add_timestamp("start_" + "resp check, end of experiment_" + 'a_all_0.00_b_gray_1.00')
  #Upload stimulus
  arduino_upload('a_all_0.00_b_gray_1.00')
  #Leave LED stimulus on for the StimTime
  time.sleep(StimTime-uploadTime)
  #Add timestamp for end of stimulus
  add_timestamp("end_" + "resp check, end of experiment_" + 'a_all_0.00_b_gray_1.00')
  #LEDs controller set to neutral state
  arduino_upload(arduino_neutral)
  #Leave LEDs in neutral state for the interStimTime
  time.sleep(interStimTime-uploadTime)
  #Add timestamp for start of stimulus
  add_timestamp("start_" + "resp check, end of experiment_" + 'a_gray_1.00_b_all_0.00')
  #Upload stimulus
  arduino_upload('a_gray_1.00_b_all_0.00')
  #Leave LED stimulus on for the StimTime
  time.sleep(StimTime-uploadTime)
  #Add timestamp for end of stimulus
  add_timestamp("end_" + "resp check, end of experiment_" + 'a_gray_1.00_b_all_0.00')
