...
Upload_Folder_ID = '1MFEJgs_S_iisfk-9N_KvBOZcLdn8kGPM'
...
ramp_470 = [
   'a_470_3.00_b_gray_0.50',
   'a_gray_0.50_b_470_3.00',
   'a_470_2.00_b_gray_0.50',
   'a_gray_0.50_b_470_2.00',
   'a_470_1.50_b_gray_0.50',
   'a_gray_0.50_b_470_1.50',
   'a_470_1.00_b_gray_0.50',
   'a_gray_0.50_b_470_1.00',
   'a_470_0.70_b_gray_0.50',
   'a_gray_0.50_b_470_0.70',
   'a_470_0.40_b_gray_0.50',
   'a_gray_0.50_b_470_0.40',
   'a_470_0.20_b_gray_0.50',
   'a_gray_0.50_b_470_0.20',   
...
ramp_625 = [
   'a_625_3.00_b_gray_0.50',
   'a_gray_0.50_b_625_3.00',
   'a_625_2.00_b_gray_0.50',
   'a_gray_0.50_b_625_2.00',
   'a_625_1.50_b_gray_0.50',
   'a_gray_0.50_b_625_1.50',
   'a_625_1.00_b_gray_0.50',
   'a_gray_0.50_b_625_1.00',
   'a_625_0.70_b_gray_0.50',
   'a_gray_0.50_b_625_0.70',
   'a_625_0.40_b_gray_0.50',
   'a_gray_0.50_b_625_0.40',
   'a_625_0.20_b_gray_0.50',
   'a_gray_0.50_b_625_0.20',   
   'a_all_0.00_b_gray_0.50',
   'a_gray_0.50_b_all_0.00']
...
totalExpDuration = \
  ...
  len(ramp_625) * (StimTime + interStimTime) + \
  len(ramp_525) * (StimTime + interStimTime) + \
  len(ramp_470) * (StimTime + interStimTime) + \
...
try:
  ...
  for i in range(len(ramp_625)):
    #Add timestamp for start of stimulus
    add_timestamp("start_" + "625 nm intensity ramp_" + ramp_625[i] )
    #Upload stimulus
    arduino_upload(ramp_625[i])
    #Leave LED stimulus on for the StimTime
    time.sleep(StimTime-uploadTime)
    #Add timestamp for end of stimulus
    add_timestamp("end_" + "625 nm intensity ramp_" + ramp_625[i])
  ...
  for i in range(len(ramp_470)):
    #Add timestamp for start of stimulus
    add_timestamp("start_" + "470 nm intensity ramp_" + ramp_470[i] )
    #Upload stimulus
    arduino_upload(ramp_470[i])
    #Leave LED stimulus on for the StimTime
    time.sleep(StimTime-uploadTime)
    #Add timestamp for end of stimulus
    add_timestamp("end_" + "470 nm intensity ramp_" + ramp_470[i])
    #outputs time stamp to console
    print ("-- Stimulus period complete at %s --"%time_stamps[-1][1])
    #LEDs controller set to neutral state
    arduino_upload(arduino_neutral)
